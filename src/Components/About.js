...
const About = () => (
  <Card>
    <Card.Body>
      ...
      <Card.Text>
        Welcome to <strong>Jobalike</strong>, where we are dedicated to connecting talent with opportunities, revolutionizing the way individuals find meaningful employment, and helping businesses discover exceptional talent.
      </Card.Text>

      <Card.Title>Our Mission</Card.Title>
      <Card.Text>
        At <strong>Jobalike</strong>, our mission is to empower individuals to build fulfilling careers and assist businesses in recruiting the best talent. We understand the transformative power of matching the right people with the right opportunities, and we're committed to making this process seamless and rewarding.
      </Card.Text>
      ...
      <Card.Title>Join Jobalike Today</Card.Title>
      <Card.Text>
        Whether you're a job seeker looking for the next step in your career or an employer seeking exceptional talent, <strong>Jobalike</strong> is here to guide you on your journey. Join us today, and let's shape the future of work together.
      </Card.Text>
